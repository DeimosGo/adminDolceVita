            ...
            <div class="w-full lg:w-1/2 flex flex-row items-center justify-center space-x-4">
                ...
                >
                    ...
                    <div
                        ...
                        dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white-0
                        after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white-0
                        after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all
                        dark:border-gray-600 peer-checked:bg-azureMarine-600"
                    ></div>
                </label>
            </div>
            <date-picker
